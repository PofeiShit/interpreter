...
void expression_test()
{
	...
	// insrtuction : 
	int res[] = {6, 1, 0, -1, 13, 0, 3, 9, 13, 0, 2, 9, 25, 11, 0, -1, 9, 8, 8, 
			6, 5, 0, -4, 13, 1, (int)data + 4, 11, 0, -4, 13, 1, data + 4 + 24, 11, 
			0, -1, 13, 1, 4, 11, 0, -1, 13, 1, 6, 13, 1, (int)data, 9, 13, 3, (int)(old_text + 1), 7, 2, 11, 
			...
			0, -1, 13, 1, (int)data, 9, 13, 0, -2, 9, 9, 25, 11, /* a = Test4 + *d */
			0, -1, 13, 1, (int)data, 9, 13, 1, 10, 26, 11, /* a = Test4 - 10 */
			0, -1, 13, 1, (int)data, 9, 13, 0, -2, 9, 9, 26, 11, /* a = Test4 - *d */
			0, -1, 13, 0, -3, 9, 13, 0, -2, 9, 26, 13, 1, 4, 28, 11, /* a = e - d */
			0, -1, 13, 1, (int)data, 9, 13, 1, 2, 27, 11, /* a = Test4 * 2 */
			0, -1, 13, 1, (int)data, 9, 13, 1, 2, 28, 11, /* a = Test4 / 2 */
			0, -1, 13, 1, (int)data, 9, 13, 1, 2, 29, 11, /* a = Test4 % 2 */
			0, -1, 9, 4, 0x7fffffff, 0, -1, 13, 1, 4, 11, 2, 0x7fffffff, 0, -1, 13, 1, -1, 11,  /* if (a) { a = 4; } else { a = -1; } */
			0, -1, 9, 13, 1, 5, 19, 4, 0x7fffffff, 0, -1, 13, 0, -2, 9, 13, 1, 2, 13, 1, 4, 27, 25, 11, 2, 0x7fffffff, /* while (a < 5) { a = d + 2; } */
			1, 0, 8, 8, /* return 0; */
	};
